...
<script type="text/javascript" src="${ctx}/assets/_osdp/auth_role/auth_role_add.js"></script>
<style type="text/css">
#redSpan{
	color:red;
	width: 0px;
			...
			<div class="add_box_in pt-page-scaleUpCenter">
				<ul class='add_box_in_ul'>
					<li class="add_box_in_uli add_box_in_textarea">
						<span>角色ID: <span id="redSpan">*</span></span>
						<input name="id" type="text"  placeholder="角色ID (字母数字)" maxlength="20">
					</li>
					<li class="add_box_in_uli add_box_in_textarea">
