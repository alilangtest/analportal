...
<script type="text/javascript" src="${ctx}/assets/_osdp/js/report/report/My97DatePicker/WdatePicker.js"></script>
<script type="text/javascript" src="${ctx}/assets/_osdp/js/report/report/updateReport.js"></script>
<style type="text/css">
#redSpan{
	color:red;
	width: 0px;
