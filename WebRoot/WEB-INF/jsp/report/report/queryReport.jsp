...
<script type="text/javascript" src="${ctx}/assets/_osdp/js/report/report/report.js"></script>
<style type="text/css">
	body, html {
					...
					<section class="wrapper site-min-height">
						<section class="panel">
							<header class="panel-heading">
								<span class="label label-primary new_label">报表维护</span> <span
									...
									<div class="clearfix">
										<div class="btn-group text-right float-right" style=''>
											<div class='float-rightd'>
												...
												<input type="text" style="width:200px;" id="reportname" name="reportname" class="form-control" 
