...
<script type="text/javascript"
	src="${ctx}/assets/_osdp/js/tableau/tableauServerAdd.js"></script>
</head>
<body>
<form id="savePcTableauConfig" method="post">
	...
	<!-- <div>
		<form id="savePcTableauConfig" method="post">
			<table align="center">
				<tr>
					<td><span style='width: 100%;'>tableau服务器IP：</span></td>
					<td><input id="tableauserverip" name="tableauserverip" /></td>
					<td><span style='width: 100%;'>postgreURL：</span></td>
					<td><input id="postgreurl" name="postgreurl" /></td>
				</tr>
				<tr>
					<td><span style='width: 100%;'>postgre用户名：</span></td>
					<td><input id="postgreuname" name="postgreuname" /></td>
					<td class='newtrtr'><span style='width: 100%;'>postgre密码：</span></td>
					<td><input id="postgrepwd" name="postgrepwd" /></td>
				</tr>
				<tr align="center">
					<td><a href="#" id="savebutton" onclick="saveTableauConfig()"><span>保存</span></a>
						<a href="#" onclick="closeTableauConfig()"><span>取消</span></a></td>
				</tr>
			</table>
		</form>
	</div> -->
