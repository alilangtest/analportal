...
<script type="text/javascript" src="${ctx}/assets/_osdp/js/queryReport/queryReportMenu/reportMenu.js"></script>
<style type="text/css">
body, html {
		...
		<section class="wrapper site-min-height">
			<section class="panel">
				<header class="panel-heading">
					<span class="label label-primary new_label">即席报表菜单维护</span> <span
