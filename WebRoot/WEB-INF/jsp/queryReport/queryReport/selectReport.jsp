...
<script type="text/javascript" src="${ctx}/assets/_osdp/js/queryReport/queryReport/selectReport.js"></script>
						...
						<div class="adv-table editable-table ">
							<div class="clearfix">
								<div class="btn-group text-right float-right" style="">
									...
									<button onclick="queryReport()" class="btn btn-info green">查询</button>
									<button onclick="clearQuery()" class="btn btn-info green">
										清空</button>
								</div>
							</div>
						</div>
