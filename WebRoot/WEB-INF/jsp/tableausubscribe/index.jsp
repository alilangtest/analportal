...
<script type="text/javascript">
	var _ctx = '${ctx}',EL=EL||{},FN=FN||{},GV=GV||{},URLS=URLS||{};
</script>
<!DOCTYPE html>
<html lang="en">
<head>
...
<script src='${ctx}/js/tableausubscribe/indexExcel.js'></script>
...
<body>
		...
		<div class="main_one_in">
			<div class="h5_header">
				...
				<div class="button_search">
					<input type="text" id="searchName" name="search" style="height: 34px" placeholder="请输入主题/表名称、订阅人、发送状态或发送时间" />
	...
	<div class="tanchuang" style='display: none;'>
		...
		<div class="tanchuang1 tanchuang0" style='display: none;'>
			...
			<div class="xuanze-box clearfix">
				<ul class='xuanze_list fl' id="dashboard_list">
				</ul>
				<ul class='xuanze_list tebie fr' id="xuanze_list">
				</ul>
			</div>
			...
			<div class="tanc_c_center" style="margin-left:20px;">
					<ul>
						...
						<li id="hourLi"><input type="number" value='' id="hour"
							onchange="changeTimeHtml()" max="23" min="0"> <span>时</span>
						</li>
						<li id="minuteLi"><input type="number" value='' id="minute"
							onchange="changeTimeHtml()" max="59" min="0"> <span>分</span>
						</li>
						<li id="hourSendOper" class="hoursendoper" style="display: none">
							<button onclick="addHourSend()" class="add-btn" style="cursor: pointer;">添加</button>
							<button onclick="delHourSend()" class="add-btn" style="cursor: pointer;">移除</button>
						</li>
						<div id="tHourSend" class="hoursend-box" style="display: none">
							<div class="hoursend_b">
								<ul class="hoursend_ul"></ul>
							</div>
						</div>
					</ul>
				</div>
			...
			<div class="">
				<div class="">
					...
					<div class="email-threm">
						...
						<button onclick="addMail()" class="add-btn" style="cursor: pointer;">添加</button>
						<button onclick="delMail()" class="add-btn" style="cursor: pointer;">移除</button>
					</div>
				</div>
				<div class="mail-box">
			...
			<div class="tanc_c_center" style="padding:0; ">
					<ul style="display:block; margin-top:0;">
						...
						<li id="detailsLi" style="margin-left:20px;">
							<table class="table-sty" style="width: 100%;">
								<tr>
									<!-- <td valign="top"><span>正文：</span></td> -->
									<td ><span>正文：</span></td>
									<td>
										<!-- <input type="text" id="sendInfo" name="sendInfo" placeholder="请输入你的内容" style='height:150px;width:400px;'> -->
										<textarea rows="6" cols="60" placeholder="请输入你的内容......" id="sendInfo" name="sendInfo" class="textarex-sty"></textarea>
									</td>
								</tr>
							</table>
						</li>
					...
					<div class="excelTabName_c" style="height:auto;">
						<div class="addDate">
							<!-- 筛选天数：<input style="width: 25px;" type="text" id="addDate"
							 ...
							 筛选天数：<input style="width: 25px;" type="text" id="addDate" name="addDate" placeholder="">
						</div>
						&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<div class="tanc_c_centerExcel">
					<ul style="margin-top:33px;">
						...
						<li id="hourLiExcel"><input type="number" value=''
							id="hourExcel" onchange="changeTimeHtmlExcel()" max="23" min="0">
							<span>时</span></li>
