...
URLS.queryMenuTree=_ctx + '/reportMenu/queryMenuTree.do';
URLS.queryLikeRoleTreeList=_ctx + '/report/queryLikeRoleTreeList.do';
URLS.queryRoleMenu=_ctx + '/report/queryRoleMenu.do';
URLS.saveRoleMenuReport=_ctx + '/report/saveRoleMenuReport.do';
