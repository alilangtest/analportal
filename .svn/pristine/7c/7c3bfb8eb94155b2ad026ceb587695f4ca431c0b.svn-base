...
//		log.info("转向页面");
	...
	@ResponseBody
	public Object queryAuthOrg(){
		return this.logService.queryAuthOrg();
	}
	@RequestMapping("/queryAuthUser")
	@ResponseBody
	public Object queryAuthUser(String authOrg){
		return this.logService.queryAuthUser(authOrg);
	}
	@RequestMapping("/queryOpercontent")
	@ResponseBody
	public Object queryOpercontent(){
		return this.logService.queryOpercontent();
	}
