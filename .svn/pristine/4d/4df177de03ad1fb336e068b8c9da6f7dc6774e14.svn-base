 ...
 * mangtype        //管户设置	
 * drawtime        //渲染时间	
 * tableauserver   //tableau服务器IP	
 * handship        //职务开关	
 * datetype        //报表有效期截止时间	
 * pushtype        //是否推送	
 */
public class IdaPmReportBo{
	...
	private String datescreen; 			//报表有效期截止时间
	public IdaPmReportBo() {
		super();
	}
	public IdaPmReportBo(String reportid, String reportname, String projectname, String reportzhname, String reporttype,
