...
<body class='table_css'>
	<div style="margin-left:30px;position: absolute;height: 39px;top: 4px;width: 100%;z-index: 1;">
	 ...
	 <div id="cc" class="easyui-layout" fit="true" style="height: 300px;">
			<div  id="left" region="west" split="false" style="width:350px; height: 80%; padding: 25px 15px 0px;">
				<table id="leftrole" style="height: 80%;"></table>
			</div>
			...
			<div id="east" region="east"  style="width: 350px; height: 80%; padding: 25px 15px 0px;">
