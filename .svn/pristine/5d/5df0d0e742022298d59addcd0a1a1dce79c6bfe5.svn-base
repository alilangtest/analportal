...
<script type="text/javascript" src="${ctx}/assets/_osdp/auth_user/auth_user_password.js"></script>
<style type="text/css">
			...
			<div class="add_box_in pt-page-scaleUpCenter">
				<ul class='add_box_in_ul'>
					<li class="add_box_in_uli add_box_in_textarea">
						<span>当前登录密码: <span id="redSpan">*</span></span>
						<input name="oldPassword" type="password">
					</li>
					<li class="add_box_in_uli add_box_in_textarea">
						<span>新的登录密码: <span id="redSpan">*</span></span>
						<input name="newPassword" type="password">
					</li>
					<li class="add_box_in_uli add_box_in_textarea">
						<span>确认新的登录密: <span id="redSpan">*</span></span>
