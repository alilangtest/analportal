package byit.aladdin.report.entity;
...
public class IdaPmReport implements java.io.Serializable {
	...
	private String mountstate;//挂载状态（0未挂载，1已挂载）
	...
	public IdaPmReport(String reportid, String reportname, String projectname, String reportzhname, String reporttype,
			...
			String panelheight, String reportdescription, String dateScreen, String workbookid, String workbookname,
			String siteid, Date getTime, String mountstate) {
		super();
