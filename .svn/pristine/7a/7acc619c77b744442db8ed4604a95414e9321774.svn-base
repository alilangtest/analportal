var URLS = URLS || {};
URLS.saveReport=_ctx + '/queryReport/saveReport.do';
URLS.saveAttribute=_ctx + '/queryReport/saveAttribute.do';
URLS.queryAttribute=_ctx + '/queryReport/queryAttribute.do';
